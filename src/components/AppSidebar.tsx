...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Brain,
    items: [
      { title: "Central de IA", url: "/central-ia", icon: Brain, roles: ["admin"] },
      { title: "Fila de Notificações", url: "/central-notificacoes", icon: MessageCircle, roles: ["admin"] },
      { title: "Observabilidade", url: "/observabilidade", icon: Activity, roles: ["admin"] },
  ...
  const visibleGroups = navGroups
    .map((group) => ({
      ...
      items: group.items.filter((item) =>
        item.roles.some((r) => visibleRoles.includes(r)),
      ),
    }))
